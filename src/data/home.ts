export const home = {
  ...
  steps: [
    {
      title: 'Hör av dig',
      text: 'Ring eller skicka en förfrågan. Skriv gärna registreringsnummer och vad som är fel.',
    },
    {
      title: 'Vi stämmer av',
      text: 'Vi återkommer, bokar en tid och säger hur du lämnar släpet.',
    },
    {
      title: 'Lämna släpet',
